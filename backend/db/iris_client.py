...
class MemoryIRISClient:
    ...
    def _seed_demo_data(self) -> None:
        ...
        facility = Facility(
            ...
            name="PT. Kimia Farma Tbk — Pabrik Bandung",
            address="Jl. Pajajaran No.29, Bandung, Jawa Barat 40171",
            lat=-6.9175,
            lng=107.6010,
            org_id="org_kimiafarma",
            google_place_id="kimiafarma-bandung-placeholder",
            osm_building_id="osm-kimiafarma-1",
        ...
        self.units[unit_id] = Unit(
            unit_id=unit_id,
            facility_id=facility_id,
            name="Lantai Produksi Utama",
            floor=1,
            unit_type="pharmaceutical_plant",
            created_at=created_at,
        )
        ...
        scene_graph = {
            "units": [
                {
                    "unit_id": "unit_1",
                    "unit_type": "Pharmaceutical Plant",
                    "rooms": [
                        # ── Entry / Gowning Area ───────────────────────────────
                        {
                            "room_id": "KF-ENTRY",
                        ...
                        # ── Main Corridor ──────────────────────────────────────
                        {
                            ...
                            "equipment": [
                                {"type": "fire_extinguisher", "position": "wall mount near entry", "accessible": True, "confidence": 0.92},
                            ],
                            "adjacency": ["KF-ENTRY", "KF-PROD-A", "KF-PROD-B", "KF-PROD-C", "KF-K3-POST", "KF-CHEM-STORE", "KF-GUDANG", "KF-QC", "KF-UTILITY"],
                        ...
                        # ── Production Areas ───────────────────────────────────
                        {
                            ...
                            "equipment": [
                                {"type": "monitor", "position": "CCTV wall mount", "accessible": True, "confidence": 0.95},
                                {"type": "hand_hygiene_dispenser", "position": "door entry", "accessible": True, "confidence": 0.97},
                                {"type": "fire_extinguisher", "position": "near exit door", "accessible": True, "confidence": 0.90},
                                {"type": "call_light", "position": "emergency button near machine", "accessible": True, "confidence": 0.88},
                            ],
                            "adjacency": ["KF-HALL"],
                            "sightline_to_nursing_station": True,
                            "image_source_quality": "supplemental",
                        ...
                        },
                        {
                            "room_id": "KF-PROD-B",
                            "type": "production_floor",
                            "area_sqft_estimate": 480,
                            "equipment": [
                                {"type": "monitor", "position": "CCTV wall mount", "accessible": True, "confidence": 0.93},
                                {"type": "ventilator", "position": "LEV hood above mixing tank", "accessible": True, "confidence": 0.89},
                                {"type": "hand_hygiene_dispenser", "position": "door entry — low stock", "accessible": False, "confidence": 0.72},
                            ],
                            "adjacency": ["KF-HALL"],
                            "sightline_to_nursing_station": True,
                            "image_source_quality": "supplemental",
                        ...
                        },
                        {
                            "room_id": "KF-PROD-C",
                            "type": "production_floor",
                            "area_sqft_estimate": 450,
                            "equipment": [
                                {"type": "monitor", "position": "CCTV ceiling mount", "accessible": True, "confidence": 0.91},
                                {"type": "hand_hygiene_dispenser", "position": "missing", "accessible": False, "confidence": 0.85},
                                {"type": "call_light", "position": "missing", "accessible": False, "confidence": 0.78},
                            ],
                            "adjacency": ["KF-HALL-FAR"],
                            "sightline_to_nursing_station": False,
                        ...
                        # ── K3 Safety Post ─────────────────────────────────────
                        {
                            ...
                            "area_sqft_estimate": 200,
                            "equipment": [
                                {"type": "workstation", "position": "K3 officer desk", "accessible": True, "confidence": 0.96},
                                {"type": "monitor", "position": "safety monitoring display", "accessible": True, "confidence": 0.94},
                            ],
                            "adjacency": ["KF-HALL"],
                            "sightline_to_nursing_station": False,
                            "image_source_quality": "supplemental",
                        ...
                        # ── Chemical Storage (B3) ──────────────────────────────
                        {
                            "room_id": "KF-CHEM-STORE",
                            "type": "chemical_storage_area",
                            "area_sqft_estimate": 300,
                            "equipment": [
                                {"type": "safety_cabinet", "position": "back wall", "accessible": True, "confidence": 0.93},
                                {"type": "fire_extinguisher", "position": "near door — obstructed by pallet", "accessible": False, "confidence": 0.87},
                            ],
                            "adjacency": ["KF-HALL"],
                            "sightline_to_nursing_station": False,
                            "image_source_quality": "supplemental",
                        ...
                        # ── Warehouse / Storage ────────────────────────────────
                        {
                            ...
                            "equipment": [
                                {"type": "monitor", "position": "CCTV corner mount", "accessible": True, "confidence": 0.88},
                                {"type": "fire_extinguisher", "position": "far wall — empty rack blocking", "accessible": False, "confidence": 0.79},
                            ],
                            "adjacency": ["KF-HALL"],
                            "sightline_to_nursing_station": False,
                            "image_source_quality": "supplemental",
                        ...
                        {
                            "room_id": "KF-QC",
                            "type": "quality_control_lab",
                            "area_sqft_estimate": 250,
                            "equipment": [
                                {"type": "safety_cabinet", "position": "fume hood right", "accessible": True, "confidence": 0.95},
                                {"type": "workstation", "position": "analysis bench", "accessible": True, "confidence": 0.92},
                                {"type": "eyewash_station", "position": "missing — B3 chemicals present", "accessible": False, "confidence": 0.88},
                            ],
                            "adjacency": ["KF-HALL"],
                            "sightline_to_nursing_station": False,
                            "image_source_quality": "supplemental",
                        ...
                        # ── Utility Room ───────────────────────────────────────
                        {
                            ...
                            "equipment": [
                                {"type": "workstation", "position": "control panel", "accessible": True, "confidence": 0.95},
                                {"type": "monitor", "position": "HVAC monitoring screen", "accessible": True, "confidence": 0.93},
                            ],
                            "adjacency": ["KF-HALL"],
                            "sightline_to_nursing_station": False,
                            "image_source_quality": "supplemental",
            ...
            "flow_annotations": {
                "patient_flow_paths": [["KF-ENTRY", "KF-HALL", "KF-PROD-A"]],
                "staff_flow_paths": [["KF-K3-POST", "KF-HALL", "KF-CHEM-STORE"]],
                "clean_corridors": ["KF-HALL"],
                "dirty_corridors": ["KF-GUDANG", "KF-CHEM-STORE"],
            },
        }
        ...
        self.models["model_unit_1"] = WorldModel(
            ...
            caption="PT. Kimia Farma — Pabrik Bandung world model",
    ...
    def create_facility(self, payload: FacilityCreate) -> Facility:
        ...
        self.units[unit_id] = Unit(
            unit_id=unit_id,
            facility_id=facility_id,
            name=payload.unit_name or "Lantai Produksi Utama",
            floor=payload.floor,
...
class FHIRServiceIRISClient(MemoryIRISClient):
    """
    FHIR-only mode: keep VeSafe domain data in the in-memory dev store,
    ...
    def _verify_native_global_access(self) -> None:
        try:
            ...
            raise RuntimeError(
                ...
                "%Native_GlobalAccess resource. Re-run the VeSafe IRIS bootstrap so the service role "
