...
_EQ_HEIGHT: dict[str, float] = {
    ...
    "fire_extinguisher":      0.48,  # 0.9m bracket height (APAR)
    "eyewash_station":        0.26,  # 1.1m nozzle height
    "safety_cabinet":         0.21,  # 1.15m cabinet door
    "safety_station":         0.37,  # 1.0m counter
    "call_light":             0.54,  # 0.85m wall mount (alarm button)
    "workstation":            0.37,  # 1.0m desk
    "ventilator":             0.26,  # 1.1m LEV control
    "monitor":               -0.51,  # 1.8m CCTV/display
}
