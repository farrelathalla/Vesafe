...
# VeSafe extension base URL
_EXT_BASE = "https://vesafe.id/fhir/StructureDefinition"
...
def _device_subject(unit_id: str) -> dict:
    """
    FHIR Observation/DiagnosticReport requires a subject.  Because VeSafe
...
def build_diagnostic_report(scan: Scan) -> dict:
    ...
    resource: dict = {
        ...
        "meta": {
            "profile": [f"{_EXT_BASE}/VeSafeDiagnosticReport"],
        },
        "identifier": [
            {
        ...
        "code": {
            ...
            "text": f"VeSafe Scan {scan.scan_id}",
        },
...
def build_observation(finding: Finding) -> dict:
    ...
    resource: dict = {
        ...
        "meta": {
            "profile": [f"{_EXT_BASE}/VeSafeObservation"],
        },
        "identifier": [
            {
...
def build_patient_resource(intake: PatientIntake) -> dict:
    ...
    resource: dict = {
        ...
        "meta": {
            "profile": [f"{_EXT_BASE}/VeSafeEmergencyPatient"],
        },
        "identifier": [
            {
...
def build_condition_resource(intake: PatientIntake) -> dict:
    ...
    resource: dict = {
        ...
        "id": condition_id,
        "meta": {
            "profile": [f"{_EXT_BASE}/VeSafeEmergencyCondition"],
        },
        "identifier": [
            {
