    ...
    <div style={{ background: "var(--paper)", minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "24px" }}>
      ...
      <Link href="/" style={{ textDecoration: "none", marginBottom: 40 }}>
        <div style={{ fontFamily: "var(--font-display-stack)", fontSize: 22, fontWeight: 700, color: "var(--ink)", letterSpacing: "-0.03em" }}>
          Ve<span style={{ color: "var(--signal)" }}>Safe</span>
        </div>
      </Link>
      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          {[
            ...
            { label: "Email kerja",   type: "email", placeholder: "anda@perusahaan.co.id" },
            { label: "Nama fasilitas", type: "text", placeholder: "PT. Kimia Farma Tbk — Pabrik Bandung" },
            { label: "Jabatan / peran", type: "text", placeholder: "Manajer K3 / HSE Officer" },
